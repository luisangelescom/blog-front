      ...
      <section className='w-full grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 py-5'>
        {[...Array(4).keys()].map((id) =>
          <section className='relative' key={id}>
            ...
            >
              <div className='animate-pulse w-full h-full bg-black/10 dark:bg-white/50 rounded' />
            </button>
            <div className='flex flex-col border-white/20 bg-black/10 dark:bg-[#393E46] w-full h-[300px] rounded-lg p-4'>
              ...
              <div className='w-full h-1/4 flex justify-end items-end'>
                <div className='animate-pulse w-16 h-5 bg-black/10 dark:bg-white/50 rounded' />
              </div>
            </div>
          </section>
        )}
